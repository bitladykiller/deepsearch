...
from ..agents.builder import build_agents, build_checkpointer, build_memory_manager
...
# 全局 WorkflowService 单例
_SERVICE: "WorkflowService | None" = None


def get_workflow_service() -> "WorkflowService":
    """FastAPI 依赖注入：返回全局 WorkflowService 单例。"""
    global _SERVICE
    if _SERVICE is None:
